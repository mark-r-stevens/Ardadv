...
namespace ardadv
{
  namespace sensors
  {
    namespace magnetometer
    {
      ...
      //!     accept data once the SPI is enabled by taking the CS low.
      ...
      //!     SCLK.
      //! CS (Slave Select Line)
      //!     Selects the MicroMag3 as the operating slave device. The CS
      ...
      //!     CS line can be deselected until the next SPI transfer.
      //! SCLK (Serial Clock)
